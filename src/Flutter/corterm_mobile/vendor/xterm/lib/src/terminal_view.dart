...
class TerminalView extends StatefulWidget {
  ...
  /// Called when the user long-presses the terminal, in addition to the
  /// built-in word selection. Used by hosts to anchor a selection context
  /// menu at the touch point.
