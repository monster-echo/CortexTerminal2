...
/// <summary>
/// Mirrors <see cref="CortexTerminal.Gateway.Sessions.FileCategoryDetector"/>. Kept separate to
/// avoid coupling the Worker to Gateway namespaces. Both sides must agree on file categories so
/// the UI renders consistent icons across the Console and the local mirror.
/// </summary>
